Feature: Consulta
  ...
  Scenario: Angendar consulta
    ...
    And medico de nome 'Rian Wilker', cpf '11697785425', email 'rian@gmail.comm', especialidade 'Pediatra' e crm '000000' existe
    ...
    When eu preencho os campos de data '15/06/2023' e horario '15:00' e medico 'Rian Wilker' e paciente 'Maria Lyvia'
  ...
  Scenario: Vizualizar consulta
    ...
    And paciente de nome 'Rian Wilker', data_nascimento '20/11/2001', cpf '11697785425', email 'rian@gmail.com', logradouro 'Rua a', complemento 'rua', cep '55365-045', bairro 'bairro' e cidade 'Capoeiras'
